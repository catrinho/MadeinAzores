<?php /* Smarty version Smarty-3.1.19, created on 2016-03-17 17:12:10
         compiled from "/Users/ruirocha/Sites/PROJECTOS/MADE_IN_AZORES/NOVO-TEMA-2016/prestashop/themes/madeinazores-2016SS_v0.1/authentication.tpl" */ ?>
<?php /*%%SmartyHeaderCode:139819388056eae56a1de4d9-69803322%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ec298dad93f865f6711569a8e62732d358bd712f' => 
    array (
      0 => '/Users/ruirocha/Sites/PROJECTOS/MADE_IN_AZORES/NOVO-TEMA-2016/prestashop/themes/madeinazores-2016SS_v0.1/authentication.tpl',
      1 => 1455814382,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '139819388056eae56a1de4d9-69803322',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_56eae56c732571_71834767',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56eae56c732571_71834767')) {function content_56eae56c732571_71834767($_smarty_tpl) {?>
...
<h1 class="page-heading text-center"><?php if (!isset($_smarty_tpl->tpl_vars['email_create']->value)) {?><?php echo smartyTranslate(array('s'=>'Authentication'),$_smarty_tpl);?>
...
?>
	...
	<?php }?>-->
	<div class="row">
		<div id="autentication-form" class="col-xs-12 col-sm-12">
...
" method="post" id="login_form" class="box">
			...
			<div class="form_content align-center clearfix">
					<div class="form-group align-center col-lg-6 ">
...
<?php }?>" />
					...
					<p class="submit align-center text-center" >
...
" /><?php }?>
						<button type="submit" id="SubmitLogin" name="SubmitLogin" class="button btn btn-default button-black">
							<span>
					...
					<p class="lost_password form-group align-center text-center col-lg-6"><a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('password'), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Recover your forgotten password'),$_smarty_tpl);?>
" rel="nofollow" class="a"><?php echo smartyTranslate(array('s'=>'Forgot your password?'),$_smarty_tpl);?>
</a></p>
				</div>
			</form>
		</div>

		<div id="new-customer-form"class="col-xs-12 col-sm-12">
			<form action="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('authentication',true), ENT_QUOTES, 'UTF-8', true);?>
" method="post" id="create-account_form" class="box">
				 <h1 class="page-heading text-center"><?php echo smartyTranslate(array('s'=>'New Customer'),$_smarty_tpl);?>
</h1> 				<div class="form_content clearfix align-center">
					<!-- <p class="text-center"><?php echo smartyTranslate(array('s'=>'Please enter your email address to create an account.'),$_smarty_tpl);?>
</p> -->
...
<?php }?>" />
					...
					<div class="submit align-center text-center">
						<?php if (isset($_smarty_tpl->tpl_vars['back']->value)) {?><input type="hidden" class="hidden" name="back" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['back']->value, ENT_QUOTES, 'UTF-8', true);?>
" /><?php }?>
...
" method="post" id="new_account_form" class="std clearfix">
			<div class="box">
				<div id="opc_account_form" style="display: block; ">
					<h1 class="page-heading align-center text-center bottom-indent"><?php echo smartyTranslate(array('s'=>'Instant checkout'),$_smarty_tpl);?>
</h1>
					<!--<p class="required"><!--<sup>*</sup>--<?php echo smartyTranslate(array('s'=>'Required field'),$_smarty_tpl);?>
</p>-->
					<!-- Account -->
					<div class="required form-group align-center col-lg-6 ">
...
<?php }?>" />
					...
					<div class="cleafix align-center gender-line col-lg-6 unpad">
...
<?php }?>" />
					...
					<div class="form-group align-center col-lg-6  date-select">
...
&nbsp;&nbsp;</option>
					...
					<div class="check-buttons">
						<div class=" align-center checkbox col-lg-6 unpad">
					...
					<h1 class="page-heading align-center text-center bottom-indent top-indent"><?php echo smartyTranslate(array('s'=>'Delivery address'),$_smarty_tpl);?>
</h1>
...
<?php }?>" />
							...
							<div class="required dni form-group align-center col-lg-6 ">
...
<?php }?>" />
						...
						<?php } elseif ($_smarty_tpl->tpl_vars['field_name']->value=="address2") {?>
							<div class="form-group align-center col-lg-6  is_customer_param">
...
<?php }?>" />
						...
						<?php } elseif ($_smarty_tpl->tpl_vars['field_name']->value=="postcode") {?>
							...
							<div class="required postcode form-group align-center col-lg-6 ">
...
<?php }?>" />
						...
						<?php } elseif ($_smarty_tpl->tpl_vars['field_name']->value=="Country:name"||$_smarty_tpl->tpl_vars['field_name']->value=="country") {?>
							<div class="required select form-group align-center col-lg-6 ">
...
"<?php if ((isset($_POST['id_country'])&&$_POST['id_country']==$_smarty_tpl->tpl_vars['v']->value['id_country'])||(!isset($_POST['id_country'])&&$_smarty_tpl->tpl_vars['sl_country']->value==$_smarty_tpl->tpl_vars['v']->value['id_country'])) {?> selected="selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['v']->value['name'];?>
						...
						<?php } elseif ($_smarty_tpl->tpl_vars['field_name']->value=="State:name") {?>
							...
							<div class="required id_state select form-group align-center col-lg-6 ">
 ...
 <!--<sup>*</sup>--></label>
					...
					<?php if ($_smarty_tpl->tpl_vars['stateExist']->value==false) {?>
						<div class="required id_state select unvisible form-group align-center col-lg-6 ">
							<label for="id_state"><?php echo smartyTranslate(array('s'=>'State'),$_smarty_tpl);?>
 <!--<sup>*</sup>--></label>
							<select name="id_state" id="id_state" class="form-control">
								<option value="">-</option>
					...
					<?php if ($_smarty_tpl->tpl_vars['postCodeExist']->value==false) {?>
						<div class="required postcode unvisible form-group align-center col-lg-6 ">
							<label for="postcode"><?php echo smartyTranslate(array('s'=>'Zip/Postal Code'),$_smarty_tpl);?>
 <!--<sup>*</sup>--></label>
							<input type="text" class="validate form-control" name="postcode" id="postcode" data-validate="isPostCode" value="<?php if (isset($_POST['postcode'])) {?><?php echo $_POST['postcode'];?>
<?php }?>"/>
					...
					<?php if ($_smarty_tpl->tpl_vars['dniExist']->value==false) {?>
						<div class="required form-group align-center col-lg-6  dni">
							<label for="dni"><?php echo smartyTranslate(array('s'=>'Identification number'),$_smarty_tpl);?>
 <!--<sup>*</sup>--></label>
...
<?php }?>" />
					...
					<?php }?>
					<div class="<?php if (isset($_smarty_tpl->tpl_vars['one_phone_at_least']->value)&&$_smarty_tpl->tpl_vars['one_phone_at_least']->value) {?>required <?php }?>form-group align-center col-lg-6 ">
...
" />
					...
					<div id="opc_invoice_address"  class="unvisible">
						...
						<?php $_smarty_tpl->tpl_vars['postCodeExist'] = new Smarty_variable(false, null, 0);?>
						<?php $_smarty_tpl->tpl_vars['dniExist'] = new Smarty_variable(false, null, 0);?>
						<h2 class="page-heading text-center top-indent"><?php echo smartyTranslate(array('s'=>'Invoice address'),$_smarty_tpl);?>
</h2>
						<?php  $_smarty_tpl->tpl_vars['field_name'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['field_name']->_loop = false;
...
<?php }?>" />
						...
						<?php } elseif ($_smarty_tpl->tpl_vars['field_name']->value=="dni") {?>
						<?php $_smarty_tpl->tpl_vars['dniExist'] = new Smarty_variable(true, null, 0);?>
						<div class="required form-group align-center col-lg-6  dni_invoice">
...
<?php }?>" />
						...
						<?php } elseif ($_smarty_tpl->tpl_vars['field_name']->value=="postcode") {?>
						<?php $_smarty_tpl->tpl_vars['postCodeExist'] = new Smarty_variable(true, null, 0);?>
						<div class="required postcode_invoice form-group align-center col-lg-6 ">
...
"<?php if ((isset($_POST['id_country_invoice'])&&$_POST['id_country_invoice']==$_smarty_tpl->tpl_vars['v']->value['id_country'])||(!isset($_POST['id_country_invoice'])&&$_smarty_tpl->tpl_vars['sl_country']->value==$_smarty_tpl->tpl_vars['v']->value['id_country'])) {?> selected="selected"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['v']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
						...
						<?php $_smarty_tpl->tpl_vars['stateExist'] = new Smarty_variable(true, null, 0);?>
						<div class="required id_state_invoice form-group align-center col-lg-6 " style="display:none;">
 ...
 <!--<sup>*</sup>--></label>
						...
						<div class="required postcode_invoice form-group align-center col-lg-6  unvisible">
							<label for="postcode_invoice"><?php echo smartyTranslate(array('s'=>'Zip/Postal Code'),$_smarty_tpl);?>
 <!--<sup>*</sup>--></label>
...
<?php }?>"/>
						...
						<div class="required id_state_invoice form-group align-center col-lg-6  unvisible">
							<label for="id_state_invoice"><?php echo smartyTranslate(array('s'=>'State'),$_smarty_tpl);?>
 <!--<sup>*</sup>--></label>
							<select name="id_state_invoice" id="id_state_invoice" class="form-control">
								<option value="">-</option>
...
" />
			...
			<p class="align-center text-center cart_navigation required submit clearfix">
...
" method="post" id="account-creation_form" class="std box">
		...
		<div class="account_creation">
			<h2 class="page-subheading align-center text-center"><?php echo smartyTranslate(array('s'=>'Your personal information'),$_smarty_tpl);?>
</h2>
			<!--<p class="required"><!--<sup>*</sup>--<?php echo smartyTranslate(array('s'=>'Required field'),$_smarty_tpl);?>
</p>-->
			<div class="clearfix align-center col-lg-6 unpad">
				<label><?php echo smartyTranslate(array('s'=>'Title'),$_smarty_tpl);?>
</label>
				<br />
				<?php  $_smarty_tpl->tpl_vars['gender'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['gender']->_loop = false;
...
<?php }?>" />
			...
			<div class="required password form-group align-center col-lg-6 ">
				<label for="passwd"><?php echo smartyTranslate(array('s'=>'Password'),$_smarty_tpl);?>
 <!--<sup>*</sup>--></label>
...
&nbsp;&nbsp;</option>
		...
		<?php if ($_smarty_tpl->tpl_vars['b2b_enable']->value) {?>
			<div class="account_creation">
				<h2 class="page-subheading align-center text-center "><?php echo smartyTranslate(array('s'=>'Your company information'),$_smarty_tpl);?>
</h2>
				<p class="form-group align-center col-lg-6 ">
...
<?php }?>" />
		...
		<?php }?>
	 	<?php if (isset($_smarty_tpl->tpl_vars['PS_REGISTRATION_PROCESS_TYPE']->value)&&$_smarty_tpl->tpl_vars['PS_REGISTRATION_PROCESS_TYPE']->value) {?> 
			<div class="account_creation">
				<h2 class="page-subheading text-center align-center"><?php echo smartyTranslate(array('s'=>'Your address'),$_smarty_tpl);?>
</h2>
				<?php  $_smarty_tpl->tpl_vars['field_name'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['field_name']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['dlv_all_fields']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['field_name']->key => $_smarty_tpl->tpl_vars['field_name']->value) {
...
<?php }?>" />
					...
					<?php } elseif ($_smarty_tpl->tpl_vars['field_name']->value=="firstname") {?>
						<p class="required form-group align-center col-lg-6 ">
							<label for="firstname"><?php echo smartyTranslate(array('s'=>'First name'),$_smarty_tpl);?>
 <!--<sup>*</sup>--></label>
...
<?php }?>" />
					...
					<?php } elseif ($_smarty_tpl->tpl_vars['field_name']->value=="address2") {?>
						<p class="form-group align-center col-lg-6  is_customer_param">
							<label for="address2"><?php echo smartyTranslate(array('s'=>'Address (Line 2)'),$_smarty_tpl);?>
<?php if (in_array($_smarty_tpl->tpl_vars['field_name']->value,$_smarty_tpl->tpl_vars['required_fields']->value)) {?> <!--<sup>*</sup>--><?php }?></label>
							<input type="text" class="form-control" name="address2" id="address2" value="<?php if (isset($_POST['address2'])) {?><?php echo $_POST['address2'];?>
<?php }?>" />
					...
					<?php } elseif ($_smarty_tpl->tpl_vars['field_name']->value=="postcode") {?>
						<?php $_smarty_tpl->tpl_vars['postCodeExist'] = new Smarty_variable(true, null, 0);?>
						<p class="required postcode form-group align-center col-lg-6 ">
							<label for="postcode"><?php echo smartyTranslate(array('s'=>'Zip/Postal Code'),$_smarty_tpl);?>
 <!--<sup>*</sup>--></label>
							<input type="text" class="validate form-control" name="postcode" id="postcode" data-validate="isPostCode" value="<?php if (isset($_POST['postcode'])) {?><?php echo $_POST['postcode'];?>
<?php }?>"/>
...
<?php }?>" />
						...
						<!-- if customer hasn't update his layout address, country has to be verified but it's deprecated -->
					<?php } elseif ($_smarty_tpl->tpl_vars['field_name']->value=="Country:name"||$_smarty_tpl->tpl_vars['field_name']->value=="country") {?>
						<p class="required select form-group align-center col-lg-6 ">
							<label for="id_country"><?php echo smartyTranslate(array('s'=>'Country'),$_smarty_tpl);?>
 <!--<sup>*</sup>--></label>
							<select name="id_country" id="id_country" class="form-control">
								<option value="">-</option>
...
"<?php if ((isset($_POST['id_country'])&&$_POST['id_country']==$_smarty_tpl->tpl_vars['v']->value['id_country'])||(!isset($_POST['id_country'])&&$_smarty_tpl->tpl_vars['sl_country']->value==$_smarty_tpl->tpl_vars['v']->value['id_country'])) {?> selected="selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['v']->value['name'];?>
					...
					<?php } elseif ($_smarty_tpl->tpl_vars['field_name']->value=="State:name"||$_smarty_tpl->tpl_vars['field_name']->value=='state') {?>
						<?php $_smarty_tpl->tpl_vars['stateExist'] = new Smarty_variable(true, null, 0);?>
						<p class="required id_state select form-group align-center col-lg-6 ">
							<label for="id_state"><?php echo smartyTranslate(array('s'=>'State'),$_smarty_tpl);?>
 <!--<sup>*</sup>--></label>
							<select name="id_state" id="id_state" class="form-control">
								<option value="">-</option>
				...
				<?php } ?>
				<?php if ($_smarty_tpl->tpl_vars['postCodeExist']->value==false) {?>
					<p class="required postcode form-group align-center col-lg-6  unvisible">
						<label for="postcode"><?php echo smartyTranslate(array('s'=>'Zip/Postal Code'),$_smarty_tpl);?>
 <!--<sup>*</sup>--></label>
						<input type="text" class="validate form-control" name="postcode" id="postcode" data-validate="isPostCode" value="<?php if (isset($_POST['postcode'])) {?><?php echo $_POST['postcode'];?>
<?php }?>"/>
				...
				<?php }?>
				<?php if ($_smarty_tpl->tpl_vars['stateExist']->value==false) {?>
					<p class="required id_state select unvisible form-group align-center col-lg-6 ">
						<label for="id_state"><?php echo smartyTranslate(array('s'=>'State'),$_smarty_tpl);?>
 <!--<sup>*</sup>--></label>
						<select name="id_state" id="id_state" class="form-control">
							<option value="">-</option>
				...
				<?php }?>
				<p class="textarea form-group align-center col-lg-6 ">
...
<?php }?>" />
				...
				<p class="<?php if (isset($_smarty_tpl->tpl_vars['one_phone_at_least']->value)&&$_smarty_tpl->tpl_vars['one_phone_at_least']->value) {?>required <?php }?>form-group align-center col-lg-6 ">
					<label for="phone_mobile"><?php echo smartyTranslate(array('s'=>'Mobile phone'),$_smarty_tpl);?>
<?php if (isset($_smarty_tpl->tpl_vars['one_phone_at_least']->value)&&$_smarty_tpl->tpl_vars['one_phone_at_least']->value) {?> <sup>**</sup><?php }?></label>
					<input type="text" class="form-control" name="phone_mobile" id="phone_mobile" value="<?php if (isset($_POST['phone_mobile'])) {?><?php echo $_POST['phone_mobile'];?>
<?php }?>" />
				...
				<?php }?>
				<p class="required form-group align-center col-lg-6 " id="address_alias">
...
<?php }?>" />
			...
			<div class="account_creation dni">
				<h2 class="page-subheading text-center align-center"><?php echo smartyTranslate(array('s'=>'Tax identification'),$_smarty_tpl);?>
</h2>
				<p class="required form-group align-center col-lg-6 ">
					<label for="dni"><?php echo smartyTranslate(array('s'=>'Identification number'),$_smarty_tpl);?>
 <!--<sup>*</sup>--></label>
...
<?php }?>" />
		...
		<div class="submit align-center text-center clearfix">
