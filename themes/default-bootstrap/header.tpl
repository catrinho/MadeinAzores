...
<html{if isset($language_code) && $language_code} lang="{$language_code|escape:'html':'UTF-8'}"{/if}>
	<head>
		...
		{/if}
		{$HOOK_HEADER}
		<!-- <link rel="stylesheet" href="http{if Tools::usingSecureMode()}s{/if}://fonts.googleapis.com//css?family=PT+Sans:400,700,400italic,700italic|PT+Sans+Narrow:400,700;subset=latin,latin-ext" type="text/css" media="all" /> -->
		...
		<div id="page">
			...
			<div class="columns-container">
				<div id="columns" class="container">
					...
					<div class="row">
						<!-- LEFT SIDE COLUMN -->
						<div id="left_column" class="column col-xs-12 col-sm-3 col-md-3 col-lg-3">
							<div id="header_logo">
