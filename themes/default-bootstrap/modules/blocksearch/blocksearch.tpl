...
<div id="search_block_left" class="block exclusive">
	...
	<form method="get" action="{$link->getPageLink('search', true, null, null, false, null, true)|escape:'html':'UTF-8'}" id="searchbox">
		...
		<p class="block_content clearfix">
			...
			<input class="search_query form-control grey" placeholder="{*l s='Search products:' mod='blocksearch'*}Search" type="text" id="search_query_block" name="search_query" value="{$search_query|escape:'htmlall':'UTF-8'|stripslashes}" />
