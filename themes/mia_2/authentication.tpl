...
{capture name=path}
	...
	{/if}
{/capture}
<h1 class=" row page-heading">{if !isset($email_create)}{l s='Authentication'}{else}{l s='Create an account'}{/if}</h1>
...
{if !isset($email_create)}
	...
	{/if}-->
	<div class="row">
		<div class="no-padding-left col-xs-12 col-sm-6">
		...
		<div class="no-padding-right col-xs-12 col-sm-6">
				...
				<div id="opc_account_form" style="display: block; ">
					...
					<div id="opc_invoice_address"  class="unvisible">
						...
						<div class="required id_state_invoice form-group" style="display:none;">
							...
							<select name="id_state_invoice" id="id_state_invoice" class="id_state_invoice form-control"  class="form-control">
								<option value="">-</option>
							</select>
						</div>
						{/if}
...
{else}
	...
	{/if}-->
	<form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="account-creation_form" class="row std box">
