...
<div class="addresses">
	...
	{foreach from=$multipleAddresses item=address name=myLoop}
		<ul class="col-sm-6 address {if $smarty.foreach.myLoop.index % 2}alternate_item{else}item{/if}">
...
{else}
	<p class="alert alert-warning">{l s='No addresses available.'}&nbsp;</p>
{/if}

<div class="row clear address_add"><a href="{$link->getPageLink('address', true)}"><div class="myaccount table-icon rounded">&#xf067;</div>{l s='Add new address'}</a></div>
