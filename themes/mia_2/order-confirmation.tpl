...
<br />
<br />
<a class="hidden-print" href="javascript:window.print()"><div class="myaccount rounded">&#xf02f;</div> {l s='Print the confirmation'}</a></a>
<br />
<br />
<br />
{if $is_guest}
...
{else}
	...
	<a href="{$link->getPageLink('history', true)}" class="hidden-print" title="{l s='Back to orders'}">
		<div class="myaccount rounded">&#xf07a;</div> {l s='Back to orders'}</a>
