...
*  @copyright  2007-20col-lg-12 col-md-12 col-sm-12 PrestaShop SA
*  @license    http://opensource.org/licenses/afl-3.0.php  Academic Free License (AFL 3.0)
*  International Registered Trademark & Property of PrestaShop SA
*}

<!-- Block search module -->
{*<!-- <div id="search_block_left" class="block btn btn-default btn-md">
...
<div class="row show-grid">
                <div class="col-lg-12 col-md-12 col-sm-12 search-row">
                  ...
                  <h6 class="no-link">{l s='Search' mod='blocksearch'}!</h6>
	                  ...
	                  <form method="get" action="{$link->getPageLink('search', true)}" id="searchbox">
						<p class="block_content">
							...
							<input class="input-sm search-input" type="text" placeholder="{l s='search' mod='blocksearch'}"  id="search_query_block" name="search_query" value="{if isset($smarty.get.search_query)}{$smarty.get.search_query|htmlentities:$ENT_QUOTES:'utf-8'|stripslashes}{/if}" />
							</div>
							<div class="no-padding-row">
								<input type="submit" id="search_button" class="search_button" value="{l s='Search' mod='blocksearch'}" />
							</div>
