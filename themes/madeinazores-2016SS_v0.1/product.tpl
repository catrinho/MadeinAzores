...
<div itemscope itemtype="https://schema.org/Product">
	...
	<div class="primary_block row">
		...
		<div class="pb-left-column col-xs-12 col-sm-12 col-md-7">
			<h1 class="page-heading" itemprop="name">{$product->name|escape:'html':'UTF-8'}</h1>
		</div>
		<!-- left infos-->
			...
			<div id="image-block" class="clearfix">
				...
				{if $have_image}
					<span id="view_full_size">
						...
						{else}
						<a id="single_image" class="fancybox" href="{$link->getImageLink($product->link_rewrite, $cover.id_image, 'thickbox_default')|escape:'html':'UTF-8'}">
				...
				<div class="box-info-product">
					...
					{if isset($product) && $product->description}
						...
						<section class="page-product-box">
							<h5 class="page-product-heading">{l s='Description'}</h5>
							<!-- full description -->
