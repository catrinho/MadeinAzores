...
<div class="box">
	...
	<h2 class="page-subheading text-center">
	...
	<p class="required text-left align-center unpad col-lg-6"><sup>*</sup>{l s='Required field'}</p>
	<form action="{$link->getPageLink('address', true)|escape:'html':'UTF-8'}" method="post" class="std" id="add_address">
		...
		{foreach from=$ordered_adr_fields item=field_name}
			...
			{if $field_name eq 'postcode'}
				...
				<div class="required postcode form-group align-center col-lg-6 unvisible">
			...
			{if $field_name eq 'State:name'}
				...
				<div class="required id_state form-group align-center col-lg-6">
			...
			{if $field_name eq 'phone'}
				...
				<div class="form-group align-center col-lg-6 phone-number">
		...
		{/if}
		{if !$stateExist}
			<div class="required id_state form-group align-center col-lg-6 unvisible">
				<label for="id_state">{l s='State'} <sup>*</sup></label>
				<select name="id_state" id="id_state" class="form-control">
					<option value="">-</option>
				</select>
		...
		{/if}
		{if !$dniExist}
			<div class="required dni form-group align-center col-lg-6 unvisible">
				<label for="dni">{l s='Identification number'} <sup>*</sup></label>
		...
		{if isset($one_phone_at_least) && $one_phone_at_least && !$atLeastOneExists}
			<p class="inline-infos required">{l s='You must register at least one phone number.'}</p>
		{/if}
		<div class="required form-group align-center col-lg-6" id="adress_alias">
		...
		<div class="submit2 align-center text-center clearfix">
			...
			<button type="submit" name="submitAddress" id="submitAddress" class="btn btn-default button button-black">
				<span>
					{l s='Save'}
