...
{capture name=path}
	...
	{/if}
{/capture}
<h1 class="page-heading text-center">{if !isset($email_create)}{l s='Authentication'}{else}{l s='Create an account'}{/if}</h1>
	...
	<div class="row">
		<div id="autentication-form" class="col-xs-12 col-sm-12">
			...
			<div class="form_content align-center clearfix">
					...
					<p class="lost_password form-group align-center text-center col-lg-6"><a href="{$link->getPageLink('password')|escape:'html':'UTF-8'}" title="{l s='Recover your forgotten password'}" rel="nofollow" class="a">{l s='Forgot your password?'}</a></p>
				</div>
			</form>
		</div>
		...
		<div id="new-customer-form"class="col-xs-12 col-sm-12">
			<form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="create-account_form" class="box">
				 <h1 class="page-heading text-center">{l s='New Customer'}</h1> 				<div class="form_content clearfix align-center">
					<!-- <p class="text-center">{l s='Please enter your email address to create an account.'}</p> -->
		...
		<form action="{$link->getPageLink('authentication', true, NULL, "back=$back")|escape:'html':'UTF-8'}" method="post" id="new_account_form" class="std clearfix">
			<div class="box">
				<div id="opc_account_form" style="display: block; ">
					<h1 class="page-heading align-center text-center bottom-indent">{l s='Instant checkout'}</h1>
					...
					<h1 class="page-heading align-center text-center bottom-indent top-indent">{l s='Delivery address'}</h1>
					...
					{/if}
					<div class="{if isset($one_phone_at_least) && $one_phone_at_least}required {/if}form-group align-center col-lg-6 ">
					...
					<div id="opc_invoice_address"  class="unvisible">
						...
						{assign var=postCodeExist value=false}
						{assign var=dniExist value=false}
						<h2 class="page-heading text-center top-indent">{l s='Invoice address'}</h2>
 ...
 {else} 
	...
	<form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="account-creation_form" class="std box">
		...
		<div class="account_creation">
			<h2 class="page-subheading align-center text-center">{l s='Your personal information'}</h2>
			<!--<p class="required"><!--<sup>*</sup>--{l s='Required field'}</p>-->
		...
		{if $b2b_enable}
			<div class="account_creation">
				<h2 class="page-subheading align-center text-center ">{l s='Your company information'}</h2>
		...
		{/if}
	 	{if isset($PS_REGISTRATION_PROCESS_TYPE) && $PS_REGISTRATION_PROCESS_TYPE} 
			<div class="account_creation">
				<h2 class="page-subheading text-center align-center">{l s='Your address'}</h2>
				{foreach from=$dlv_all_fields item=field_name}
					{if $field_name eq "company"}
						{if !$b2b_enable}
							<p class="form-group align-center col-lg-6 ">
				...
				<p class="{if isset($one_phone_at_least) && $one_phone_at_least}required {/if}form-group align-center col-lg-6 ">
					<label for="phone_mobile">{l s='Mobile phone'}{if isset($one_phone_at_least) && $one_phone_at_least} <sup>**</sup>{/if}</label>
					<input type="text" class="form-control" name="phone_mobile" id="phone_mobile" value="{if isset($smarty.post.phone_mobile)}{$smarty.post.phone_mobile}{/if}" />
				</p>
				{if isset($one_phone_at_least) && $one_phone_at_least}
			...
			<div class="account_creation dni">
				<h2 class="page-subheading text-center align-center">{l s='Tax identification'}</h2>
				<p class="required form-group align-center col-lg-6 ">
					<label for="dni">{l s='Identification number'} <!--<sup>*</sup>--></label>
